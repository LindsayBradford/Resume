...
%    \ContactDetail{Availability}{November 2015}   
  ...
  \begin{WorkHistory}
      \CareerDetailItem{Senior Software Engineer (Contract)}{Australian Rivers Institute}{June 2018 -- Current}{
      \item Construction of River Catchment Resilience optimisation framework and web server.
      \item Implemented single and multi-objective simulated annealing optimisation algorithms.
...
%      \item Implemented performance tests via the Scala \href{https://gatling.io/}{Gatling} framework. 
      \item Worked with team members to introduce PCI \href{https://en.wikipedia.org/wiki/Payment\_Card\_Industry\_Data\_Security\_Standard\#Self-Assessment\_Questionnaire\_(SAQ)}{SAQ-A} support to the application-base.
