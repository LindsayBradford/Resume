...
\begin{document}
  ...
  \begin{Summary}{
    I am a highly motivated {\bf Senior Software Engineer} with excellent communication skills and a wealth of software analysis, design, and construction experience. I have designed and built back-end servers, decision support systems, optimisation models and rich GUI desktop applications across diverse domains. 
    I enjoy development challenges, and adapt quickly to new environments and technologies.} 
  ...
  \begin{Skills}
    ...
    \SkillSection{Technical}{Algorithm/Architecture Analysis \& Design, UML, Requirements Analysis, OOP}
    \SkillSection{Tools \& Technologies}{GIT, SQL, ArcGIS, QGIS, Json, XML, Scrum, Waterfall}
  \end{Skills}
  \begin{WorkHistory}
  ...
  \begin{Links}
    ...
    \Link{
      ...
      \href{https://github.com/LindsayBradford/MWRDTools}{MWRDTools} (C\#)
    }
    \Link{
