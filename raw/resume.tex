...
%    \ContactDetail{Availability}{November 2015}   
  ...
  \begin{Skills}
    \SkillSection{Technical Skills}{
      \Skill{Application/Architecture Analysis \& Design}
    ...
    \SkillSection{Programming Languages}{
            \Skill{\href{https://github.com/LindsayBradford/GoEuler}{Go[lang]}, Perl, Python}
  ...
  \begin{WorkHistory}
        \CareerDetailItem{Senior Software Engineer}{Truii}{Feb 2022 -- Current}{
      ...
      \item \href{https://en.wikipedia.org/wiki/Extract,_transform,_load}{ETL} activity, moving survey data from \href{https://www.esri.com/en-us/arcgis/products/arcgis-online/overview}{ArcGIS Online} to Seqwater geodatabases.  
    }
      \CareerDetailItem{Senior Software Engineer (Contract)}{Australian Rivers Institute}{June 2018 -- Dec 2021}{
      \item Construction of single-objective and multi-objective annealing modelling tool for exploring pollutant and economic trade-offs in river catchment systems.
